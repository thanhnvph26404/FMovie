...
import { CinemaPage, Dashboard, HomePage, MoviePage, MovieTypeAddPage, MovieTypeEditPage, MovieTypeListPage, PageNotFound, SchedulePage, CinemaPageAdmin, CinemaAddPage, CinemaEditPage, VoucherPageAdmin, VoucherAddPage, VoucherEditPage, RoomsAddPage, RoomsEditPage } from "./pages";
...
import RoomsPage from "./pages/admin/room/RoomListPage";
        ...
        children: [
            {
                ...
                children: [
                    ...
                    { path: "room/add", element: <RoomsAddPage /> },
                    { path: "room/edit/:id", element: <RoomsEditPage /> },
                ],
            },
        ],
    },
